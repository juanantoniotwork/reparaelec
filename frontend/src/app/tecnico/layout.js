        ...
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-8">
            <h1 className="text-xl font-bold text-blue-600 dark:text-blue-400">
              Reparaelec <span className="text-gray-400 dark:text-gray-500 font-normal">Técnico</span>
            </h1>
            <nav className="hidden md:flex space-x-6">
              <Link href="/tecnico/chat" className="flex items-center text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
                <MessageSquare className="w-4 h-4 mr-1.5" />
                Chat Asistente
              </Link>
              <Link href="/tecnico/historial" className="flex items-center text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
